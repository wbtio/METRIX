...
export interface ChallengeEvent {
  ...
  milestone?: {
    ...
    accentColor?: "emerald" | "violet" | "amber" | "rose" | "sky" | "slate";
    imageStyle?: string;
...
export const compactCopy = {
  en: {
    ...
    pendingHostSummary:
      "Your duel is ready. Share the code and let the rival join from their side.",
    pendingGuestSummary:
      "Your join request is saved and waiting for the duel to begin.",
    activeSummary: "Live scoring is active now.",
    endedSummary: "Last duel result is archived here.",
    boardTitle: "Scoreboard",
    recentTitle: "Big Achievements",
    ...
    inviteOwnerHint:
      "You already created this duel. Joining does not happen here; the rival uses this code from their goal.",
    inviteGuestHint:
      "You already joined this duel. Once the rival side is ready, the scoreboard will appear here.",
    inviteLabel: "Invite code for rival",
    archiveEmpty: "No previous duels yet.",
    activityEmpty: "No big achievements yet.",
    noCode: "--------",
    total: "Total",
    today: "Today",
    last7: "7 days",
  ...
  ar: {
    ...
    pendingHostSummary:
      "التحدي صار جاهز. فقط شارك الكود وخلي المنافس ينضم من جهته.",
    ...
    inviteOwnerHint:
      "أنت أنشأت هذا التحدي بالفعل. الانضمام لا يتم من هنا؛ المنافس يستخدم هذا الكود من هدفه.",
    inviteGuestHint:
      "أنت منضم بالفعل لهذا التحدي. بمجرد جاهزية الطرف الثاني ستظهر لوحة النقاط هنا.",
    inviteLabel: "كود الدعوة للمنافس",
    archiveEmpty: "لا توجد تحديات سابقة بعد.",
    activityEmpty: "لا توجد إنجازات كبيرة بعد.",
    noCode: "--------",
    total: "الإجمالي",
    today: "اليوم",
    last7: "7 أيام",
